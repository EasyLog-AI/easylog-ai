...
export interface ProjectPayload {
    ...
    /**
     * Additional fields (can contain strings, numbers, booleans, objects, arrays). Keys must exist in extra_data_fields on the project datasource
     * @type {object}
     * @memberof ProjectPayload
     */
...
export function instanceOfProjectPayload(value: object): value is ProjectPayload {
    ...
    if (!('reportVisible' in value) || value['reportVisible'] === undefined) return false;
    if (!('excludeInWorkdays' in value) || value['excludeInWorkdays'] === undefined) return false;
