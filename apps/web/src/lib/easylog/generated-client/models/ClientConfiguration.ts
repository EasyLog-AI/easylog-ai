...
export interface ClientConfiguration {
     ...
     * @type {Array<ClientConfigurationFiltersInner>}
     * @memberof ClientConfiguration
     */
...
export function ClientConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientConfiguration {
    ...
    return {
        ...
        'defaultTimePeriod': json['defaultTimePeriod'] == null ? undefined : json['defaultTimePeriod'],
        'filters': json['filters'] == null ? undefined : ((json['filters'] as Array<any>).map(ClientConfigurationFiltersInnerFromJSON)),
        'can': json['can'] == null ? undefined : ClientConfigurationCanFromJSON(json['can']),
...
export function ClientConfigurationToJSONTyped(value?: ClientConfiguration | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'filters': value['filters'] == null ? undefined : ((value['filters'] as Array<any>).map(ClientConfigurationFiltersInnerToJSON)),
