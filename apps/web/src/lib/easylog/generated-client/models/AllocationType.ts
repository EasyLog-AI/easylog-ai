...
export function instanceOfAllocationType(
  value: object
): value is AllocationType {
...
export function AllocationTypeFromJSONTyped(
  json: any,
...
export function AllocationTypeToJSONTyped(
  value?: AllocationType | null,
