 ...
 */
export function instanceOfEntityCollection(value: object): value is EntityCollection {
...
export function EntityCollectionToJSONTyped(value?: EntityCollection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
