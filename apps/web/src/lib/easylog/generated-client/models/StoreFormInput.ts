...
export function instanceOfStoreFormInput(
  value: object
): value is StoreFormInput {
...
export function StoreFormInputFromJSONTyped(
  json: any,
...
export function StoreFormInputToJSONTyped(
  value?: StoreFormInput | null,
