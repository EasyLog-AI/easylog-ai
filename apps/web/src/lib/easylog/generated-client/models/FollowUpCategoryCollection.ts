...
export function instanceOfFollowUpCategoryCollection(
  value: object
): value is FollowUpCategoryCollection {
  return true;
}

export function FollowUpCategoryCollectionFromJSON(
  json: any
): FollowUpCategoryCollection {
  return FollowUpCategoryCollectionFromJSONTyped(json, false);
}

export function FollowUpCategoryCollectionFromJSONTyped(
  json: any,
...
export function FollowUpCategoryCollectionToJSON(
  json: any
): FollowUpCategoryCollection {
  return FollowUpCategoryCollectionToJSONTyped(json, false);
}

export function FollowUpCategoryCollectionToJSONTyped(
  value?: FollowUpCategoryCollection | null,
