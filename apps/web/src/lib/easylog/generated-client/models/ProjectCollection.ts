...
export function instanceOfProjectCollection(
  value: object
...
export function ProjectCollectionFromJSONTyped(
  json: any,
...
export function ProjectCollectionToJSONTyped(
  value?: ProjectCollection | null,
