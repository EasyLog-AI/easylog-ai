 ...
 */
export function instanceOfSubmissionCollection(value: object): value is SubmissionCollection {
    return true;
}
...
export function SubmissionCollectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubmissionCollection {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(SubmissionFromJSON)),
...
export function SubmissionCollectionToJSONTyped(value?: SubmissionCollection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(SubmissionToJSON)),
