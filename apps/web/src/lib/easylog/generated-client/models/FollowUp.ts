...
export function FollowUpFromJSONTyped(json: any, ignoreDiscriminator: boolean): FollowUp {
    ...
    return {
        ...
        'category': json['category'] == null ? undefined : FollowUpCategoryFromJSON(json['category']),
        'scheme': json['scheme'] == null ? undefined : json['scheme'],
        'canUseJsonTable': json['can_use_json_table'] == null ? undefined : json['can_use_json_table'],
        'createdAt': json['created_at'] == null ? undefined : (new Date(json['created_at'])),
        'updatedAt': json['updated_at'] == null ? undefined : (new Date(json['updated_at'])),
        'entriesCount': json['entries_count'] == null ? undefined : json['entries_count'],
    };
}
...
export function FollowUpToJSONTyped(value?: FollowUp | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
