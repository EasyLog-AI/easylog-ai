...
export function instanceOfEntityAllocationCollection(
  value: object
): value is EntityAllocationCollection {
  if (!('data' in value) || value['data'] === undefined) return false;
  return true;
}

export function EntityAllocationCollectionFromJSON(
  json: any
): EntityAllocationCollection {
  return EntityAllocationCollectionFromJSONTyped(json, false);
}

export function EntityAllocationCollectionFromJSONTyped(
  json: any,
...
export function EntityAllocationCollectionToJSON(
  json: any
): EntityAllocationCollection {
  return EntityAllocationCollectionToJSONTyped(json, false);
}

export function EntityAllocationCollectionToJSONTyped(
  value?: EntityAllocationCollection | null,
