...
export function ProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): Project {
    ...
    return {
        ...
        'allocationTypes': json['allocation_types'] == null ? undefined : ((json['allocation_types'] as Array<any>).map(AllocationTypeFromJSON)),
        'allocationsGrouped': json['allocations_grouped'] == null ? undefined : json['allocations_grouped'],
...
export function ProjectToJSONTyped(value?: Project | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'allocation_types': value['allocationTypes'] == null ? undefined : ((value['allocationTypes'] as Array<any>).map(AllocationTypeToJSON)),
