...
export class CategoriesApi extends runtime.BaseAPI {
     ...
     * Create category
     */
    async createCategoryRaw(requestParameters: CreateCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CategoryResource>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CategoryResourceFromJSON(jsonValue));
    }
     ...
     * Create category
     */
    async createCategory(requestParameters: CreateCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CategoryResource> {
     ...
     * List categories
     */
    async listCategoriesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CategoryCollection>> {
        const queryParameters: any = {};
     ...
     * List categories
     */
    async listCategories(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CategoryCollection> {
     ...
     * List forms in a category
     */
    async listCategoryFormsRaw(requestParameters: ListCategoryFormsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FormCollection>> {
        if (requestParameters['category'] == null) {
            throw new runtime.RequiredError(
                'category',
     ...
     * List forms in a category
     */
    async listCategoryForms(requestParameters: ListCategoryFormsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FormCollection> {
        const response = await this.listCategoryFormsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Show category
     */
    async showCategoryRaw(requestParameters: ShowCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CategoryResource>> {
        if (requestParameters['category'] == null) {
            throw new runtime.RequiredError(
                'category',
     ...
     * Show category
     */
    async showCategory(requestParameters: ShowCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CategoryResource> {
     ...
     * Update category
     */
    async updateCategoryRaw(requestParameters: UpdateCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CategoryResource>> {
        if (requestParameters['category'] == null) {
            throw new runtime.RequiredError(
                'category',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateCategoryInputToJSON(requestParameters['updateCategoryInput']),
        }, initOverrides);
     ...
     * Update category
     */
    async updateCategory(requestParameters: UpdateCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CategoryResource> {
