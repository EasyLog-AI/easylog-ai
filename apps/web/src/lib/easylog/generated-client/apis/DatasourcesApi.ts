...
export class DatasourcesApi extends runtime.BaseAPI {
     ...
     */
    async listDatasourcesRaw(requestParameters: ListDatasourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EntityCollection>> {
     ...
     * List datasources for the authenticated client
     */
    async listDatasources(requestParameters: ListDatasourcesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EntityCollection> {
     ...
     */
    async listResourcesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResourceCollection>> {
        const queryParameters: any = {};
     ...
     * List resource entities
     */
    async listResources(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResourceCollection> {
     ...
     */
    async showDatasourceRaw(requestParameters: ShowDatasourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowDatasource200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ShowDatasource200ResponseFromJSON(jsonValue));
    }

    /**
     * Retrieve a single datasource
     */
    async showDatasource(requestParameters: ShowDatasourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowDatasource200Response> {
        const response = await this.showDatasourceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Retrieve a resource
     */
    async showResourceRaw(requestParameters: ShowResourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResourceCollection>> {
     ...
     * Retrieve a resource
     */
    async showResource(requestParameters: ShowResourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResourceCollection> {
        const response = await this.showResourceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async showResourceByGroupRaw(requestParameters: ShowResourceByGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowResourceByGroup200Response>> {
        if (requestParameters['resource'] == null) {
            throw new runtime.RequiredError(
                'resource',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ShowResourceByGroup200ResponseFromJSON(jsonValue));
    }

    /**
     * Retrieve resource data by group
     */
    async showResourceByGroup(requestParameters: ShowResourceByGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowResourceByGroup200Response> {
        const response = await this.showResourceByGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
