...
export class PlanningApi extends runtime.BaseAPI {
  ...
  async createProjectInDatasourceRaw(
    requestParameters: CreateProjectInDatasourceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Project>> {
  ...
  /** Create project in specific datasource */
  async createProjectInDatasource(
    requestParameters: CreateProjectInDatasourceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Project> {
    const response = await this.createProjectInDatasourceRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async listProjectsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ProjectCollection>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProjectCollectionFromJSON(jsonValue)
    );
  }
  ...
  async listProjectsForResourceRaw(
    requestParameters: ListProjectsForResourceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  /** List projects for a resource group */
  async listProjectsForResource(
    requestParameters: ListProjectsForResourceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<object>> {
    const response = await this.listProjectsForResourceRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /** Show project */
  async showProjectRaw(
    requestParameters: ShowProjectRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Project>> {
    if (requestParameters['project'] == null) {
      throw new runtime.RequiredError(
  ...
  async showProject(
    ...
    const response = await this.showProjectRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
