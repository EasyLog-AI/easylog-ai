...
export class SubmissionsApi extends runtime.BaseAPI {
     ...
     * Delete submission
     */
    async deleteSubmissionRaw(requestParameters: DeleteSubmissionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Delete submission
     */
    async deleteSubmission(requestParameters: DeleteSubmissionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     */
    async listSubmissionMediaRaw(requestParameters: ListSubmissionMediaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListSubmissionMedia200Response>> {
        if (requestParameters['submission'] == null) {
            throw new runtime.RequiredError(
                'submission',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListSubmissionMedia200ResponseFromJSON(jsonValue));
    }
     ...
     * List media for a submission
     */
    async listSubmissionMedia(requestParameters: ListSubmissionMediaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListSubmissionMedia200Response> {
        const response = await this.listSubmissionMediaRaw(requestParameters, initOverrides);
     ...
     * List submissions
     */
    async listSubmissionsRaw(requestParameters: ListSubmissionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionCollection>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SubmissionCollectionFromJSON(jsonValue));
    }
     ...
     * List submissions
     */
    async listSubmissions(requestParameters: ListSubmissionsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionCollection> {
     ...
     * Persist submission
     */
    async persistSubmissionRaw(requestParameters: PersistSubmissionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PersistSubmission201Response>> {
        ...
        urlPath = urlPath.replace(`{${"project_form"}}`, encodeURIComponent(String(requestParameters['projectForm'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PersistSubmissionRequestToJSON(requestParameters['persistSubmissionRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => PersistSubmission201ResponseFromJSON(jsonValue));
    }
     ...
     * Persist submission
     */
    async persistSubmission(requestParameters: PersistSubmissionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PersistSubmission201Response> {
        const response = await this.persistSubmissionRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async prepareSubmissionRaw(requestParameters: PrepareSubmissionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PrepareSubmission200Response>> {
        if (requestParameters['projectForm'] == null) {
            throw new runtime.RequiredError(
                'projectForm',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PrepareSubmissionRequestToJSON(requestParameters['prepareSubmissionRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => PrepareSubmission200ResponseFromJSON(jsonValue));
    }
     ...
     * Prepare submission file uploads
     */
    async prepareSubmission(requestParameters: PrepareSubmissionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PrepareSubmission200Response> {
        const response = await this.prepareSubmissionRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Show submission
     */
    async showSubmissionRaw(requestParameters: ShowSubmissionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionResource>> {
        if (requestParameters['submission'] == null) {
            throw new runtime.RequiredError(
                'submission',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SubmissionResourceFromJSON(jsonValue));
    }
     ...
     * Show submission
     */
    async showSubmission(requestParameters: ShowSubmissionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionResource> {
     ...
     * Update submission
     */
    async updateSubmissionRaw(requestParameters: UpdateSubmissionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmissionResource>> {
        if (requestParameters['submission'] == null) {
            throw new runtime.RequiredError(
                'submission',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateSubmissionInputToJSON(requestParameters['updateSubmissionInput']),
        }, initOverrides);
     ...
     * Update submission
     */
    async updateSubmission(requestParameters: UpdateSubmissionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmissionResource> {
     ...
     */
    async uploadSubmissionMediaRaw(requestParameters: UploadSubmissionMediaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UploadSubmissionMedia201Response>> {
        if (requestParameters['submission'] == null) {
            throw new runtime.RequiredError(
                'submission',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UploadSubmissionMedia201ResponseFromJSON(jsonValue));
    }
     ...
     * Upload media to a submission
     */
    async uploadSubmissionMedia(requestParameters: UploadSubmissionMediaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UploadSubmissionMedia201Response> {
        const response = await this.uploadSubmissionMediaRaw(requestParameters, initOverrides);
        return await response.value();
    }
