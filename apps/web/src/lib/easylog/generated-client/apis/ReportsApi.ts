...
export class ReportsApi extends runtime.BaseAPI {
     ...
     * Generate PDF report
     */
    async generatePdfReportRaw(requestParameters: GeneratePdfReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
     ...
     * Generate PDF report
     */
    async generatePdfReport(requestParameters: GeneratePdfReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.generatePdfReportRaw(requestParameters, initOverrides);
...
export type GeneratePdfReportAsEnum = typeof GeneratePdfReportAsEnum[keyof typeof GeneratePdfReportAsEnum];
