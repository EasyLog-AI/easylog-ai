...
export class FollowUpCategoriesApi extends runtime.BaseAPI {
     ...
     */
    async listFollowUpCategoriesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FollowUpCategoryCollection>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FollowUpCategoryCollectionFromJSON(jsonValue));
    }
     ...
     * List follow-up categories
     */
    async listFollowUpCategories(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FollowUpCategoryCollection> {
     ...
     */
    async showFollowUpCategoryRaw(requestParameters: ShowFollowUpCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FollowUpCategoryResource>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FollowUpCategoryResourceFromJSON(jsonValue));
    }
     ...
     * Show follow-up category
     */
    async showFollowUpCategory(requestParameters: ShowFollowUpCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FollowUpCategoryResource> {
        const response = await this.showFollowUpCategoryRaw(requestParameters, initOverrides);
        return await response.value();
    }
