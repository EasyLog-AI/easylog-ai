...
export class AnnouncementsApi extends runtime.BaseAPI {
  /**
   * List all announcements for the authenticated user. Automatically marks
   * unread announcements as retrieved. List announcements
   */
  async listAnnouncementsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AnnouncementCollection>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AnnouncementCollectionFromJSON(jsonValue)
    );
  }
  ...
  async listAnnouncements(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AnnouncementCollection> {
    const response = await this.listAnnouncementsRaw(initOverrides);
    return await response.value();
  }

  /**
   * Display a specific announcement. Automatically marks the announcement as
   * retrieved if not already marked. Show announcement
   */
  async showAnnouncementRaw(
    requestParameters: ShowAnnouncementRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AnnouncementResource>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AnnouncementResourceFromJSON(jsonValue)
    );
  }
  ...
  async showAnnouncement(
    ...
    const response = await this.showAnnouncementRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /**
   * Track user interaction with an announcement by recording status updates
   * (retrieved, opened, scrolled_down, opened_attachment,
   * confirmed_messages_read). Update announcement status
   */
  async updateAnnouncementStatusRaw(
    requestParameters: UpdateAnnouncementStatusRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AnnouncementResource>> {
    if (requestParameters['announcement'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AnnouncementStatusInputToJSON(
          requestParameters['announcementStatusInput']
        )
      },
      initOverrides
    );
  ...
  async updateAnnouncementStatus(
    ...
    const response = await this.updateAnnouncementStatusRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
