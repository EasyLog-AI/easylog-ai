...
export class PlanningPhasesApi extends runtime.BaseAPI {
  ...
  async createProjectPhaseRaw(
    requestParameters: CreateProjectPhaseRequest,
  ...
  async createProjectPhase(
    ...
    const response = await this.createProjectPhaseRaw(
      requestParameters,
      initOverrides
    );
  ...
  /** Delete phase */
  async deleteProjectPhaseRaw(
    requestParameters: DeleteProjectPhaseRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  /** List project phases */
  async listProjectPhasesRaw(
    requestParameters: ListProjectPhasesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  async listProjectPhases(
    ...
    const response = await this.listProjectPhasesRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /** Show phase */
  async showProjectPhaseRaw(
    requestParameters: ShowProjectPhaseRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Phase>> {
    if (requestParameters['phase'] == null) {
      throw new runtime.RequiredError(
  ...
  /** Show phase */
  async showProjectPhase(
    requestParameters: ShowProjectPhaseRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Phase> {
    const response = await this.showProjectPhaseRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /** Update phase */
  async updateProjectPhaseRaw(
    requestParameters: UpdateProjectPhaseRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Phase>> {
    if (requestParameters['phase'] == null) {
      throw new runtime.RequiredError(
  ...
  async updateProjectPhase(
    ...
    const response = await this.updateProjectPhaseRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
