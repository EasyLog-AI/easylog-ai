...
export const buttonStyles = tv({
  ...
  variants: {
    colorRole: {
      ...
      brand:
        'from-fill-brand to-fill-brand-2 text-text-brand-on-fill shadow-fill-brand/20 ring-border-brand-selected hover:shadow-fill-brand/25 data-[state=open]:shadow-fill-brand/25 border-transparent bg-gradient-to-tr shadow-md transition-transform hover:-translate-y-px hover:brightness-95 active:translate-y-0 active:brightness-90 data-[state=open]:brightness-95',
