...
export const buttonStyles = tv({
  ...
  variants: {
    colorRole: {
      ...
      brand:
        'border-transparent bg-gradient-to-tr from-fill-brand to-fill-brand-2 text-text-brand-on-fill shadow-md shadow-fill-brand/20 ring-border-brand-selected transition-transform hover:brightness-95 hover:-translate-y-px hover:shadow-fill-brand/25 active:brightness-90 active:translate-y-0 data-[state=open]:brightness-95 data-[state=open]:shadow-fill-brand/25',
